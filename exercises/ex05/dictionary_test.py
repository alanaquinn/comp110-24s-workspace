...
# 91/100 (update attendance does not repeat the same name within a day) and (LOTS of lint)
# fixed white spaces before :  ->  in brackets, it is {'xxx': ['x', 'x', 'x']}
# added periods to doc strings
# added white space in beginning
# edited dictionary.py so names could not be added multiple times in same day

# 96/100 giving up bc could not figure out how to prevent repeat